...
def analyser_commande():
    ...
    parser.add_argument("-d", "--date_debut", help="Date recherchée la plus ancienne (format: AAAA-MM-JJ)")
    parser.add_argument("-f", "--date_fin", help="Date recherchée la plus récente (format: AAAA-MM-JJ)")
